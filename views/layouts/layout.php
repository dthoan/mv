...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="public/css/plugins.css">
                        ...
                        <div class="main-navigation flex-lg-right">
                            <ul class="main-menu menu-right ">
                                ...
                                <li class="menu-item has-children mega-menu">
                                    ...
                                    <ul class="sub-menu four-column text-center" style="width: 200px;left: 0;transform: translateX(20%); padding: 10px;">
                                        <li class="cus-col-25 w-100">
                                            <ul class="mega-single-block">
                                                <li><a href="<?=BASE_URL?>?controller=home">All</a></li>
                                                <?php foreach (((new LoaihangModels())->all() ?? []) as $category) : ?>
                                                    <li><a href="<?=BASE_URL?>?controller=home&category=<?=$category['id']?>"><?=$category['category_name']?></a></li>
                                                <?php endforeach; ?>
                                            </ul>
                                        </li>
                                    </ul>
                                ...
                                <!-- Blog -->
                                <li class="menu-item has-children mega-menu">
                                    <a href="<?=BASE_URL?>?controller=news">Blog</a>
                                </li>
                                <li class="menu-item">
                                        ...
                                        <div class=" single-cart-block ">
                                            <div class="cart-product">
                                                <a href="product-details.html" class="image">
                                                    <img src="public/image/products\cart-product-1.jpg" alt="">
                                                </a>
                                                <div class="content">
    ...
    <div class="container">
        <div class="brand-slider sb-slick-slider border-top border-bottom" data-slick-setting='{
            ...
            <div class="single-slide">
                <img src="public/image/others\brand-1.jpg" alt="">
            </div>
            <div class="single-slide">
                <img src="public/image/others\brand-2.jpg" alt="">
            </div>
            <div class="single-slide">
                <img src="public/image/others\brand-3.jpg" alt="">
            </div>
            <div class="single-slide">
                <img src="public/image/others\brand-4.jpg" alt="">
            </div>
            <div class="single-slide">
                <img src="public/image/others\brand-5.jpg" alt="">
            </div>
            <div class="single-slide">
                <img src="public/image/others\brand-6.jpg" alt="">
            </div>
            <div class="single-slide">
                <img src="public/image/others\brand-1.jpg" alt="">
            </div>
            ...
            <div class=" col-xl-3 col-lg-4 col-sm-6">
                <div class="single-footer pb--40">
                    <div class="brand-footer footer-title">
                        <img src="public/image/logo--footer.png" alt="">
                    </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            ...
            <a href="#" class="payment-block">
                <img src="public/image/icon\payment.png" alt="">
            </a>
