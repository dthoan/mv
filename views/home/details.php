        ...
        <div class="row  mb--60">
            ...
            <div class="col-lg-7">
                <div class="product-details-info pl-lg--30 ">
                    <p class="tag-block">Category: <a href="#"><?=$product['category']?></a></p>
                    <h3 class="product-title"><?=$product['name']?></h3>
                    <ul class="list-unstyled">
                        <li>Discount: <span class="list-value"> <?=$product['discount']?>%</span></li>
                        <li>Availability: <span class="list-value"> In Stock</span></li>
                    </ul>
                    <div class="price-block">
                        <span class="price-new"><?=number_format($product['price_discount'])?></span>
            ...
            <div class="product-slider sb-slick-slider slider-border-single-row" data-slick-setting='{
                ...
                <?php
                    foreach (($allProducts ?? []) as $_product){
                        echo $this->render('home/templateProduct.php', [
                            'product' => $_product,
                            'isDetail' => true
                        ]);
                    }
