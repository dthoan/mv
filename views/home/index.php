<main class="inner-page-sec-padding-bottom">
    <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-5 col-md-4 col-sm-6 mt--10 mt-sm--0">
                    <span class="toolbar-status">
                        Showing <?=$products['start_record']?> to <?=$products['end_record']?> of <?=$products['all_record']?> (<?=$products['page_end']?> Pages)
                    </span>
                </div>
        ...
        <div class="shop-product-wrap grid with-pagination row space-db--30 shop-border">
            <?php
                foreach (($products['datas'] ?? []) as $product) {
                    include BASE_PATH . "/views/home/templateProduct.php";
                }
            ?>
        </div>
        <!-- Pagination Block -->
        <div class="row pt--30">
            <div class="col-md-12">
                <div class="pagination-block">
                    <?= $this->render('layouts/pagging.php', ['datas' => $products]) ?>
                </div>
            </div>
        </div>
        <!-- Modal -->
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="product-details-slider sb-slick-slider arrow-type-two"
                                    ...
                                    <div class="single-slide">
                                        <img src="public/image/products\product-details-1.jpg" alt="">
                                    </div>
                                    <div class="single-slide">
                                        <img src="public/image/products\product-details-2.jpg" alt="">
                                    </div>
                                    <div class="single-slide">
                                        <img src="public/image/products\product-details-3.jpg" alt="">
                                    </div>
                                    <div class="single-slide">
                                        <img src="public/image/products\product-details-4.jpg" alt="">
                                    </div>
                                    <div class="single-slide">
                                        <img src="public/image/products\product-details-5.jpg" alt="">
                                    </div>
                                </div>
